...
class PayslipController with ChangeNotifier {
  PayslipModel payslip = const PayslipModel(
  ...
  List<Widget> get historyRows => payslipHistoryData.map((row) {
                ...
                return Expanded(
                  ...
                  child: GestureDetector(
                    ...
                    child: const Text(
                      TextConstants.payslipGenerated,
                      style: TextStyle(
                          fontSize: 12, color: AppColors.generatedTextColor),
                    ),
                  ),
                );
  ...
  Future<void> generateAndSavePDF(String month) async {
      ...
      pw.Page(
        ...
        build: (context) => pw.Column(
          ...
          children: [
                  ...
                  children: [
                    pw.Text(TextConstants.ziyaAcademy,
                        style: pw.TextStyle(
                            ...
                            color: AppColors.payslipTitle)),
                    pw.Text(TextConstants.keyToSuccess,
                        style: pw.TextStyle(
                            fontSize: 10, color: AppColors.payslipSubtitle)),
                  ],
                ),
                pw.Column(
                  crossAxisAlignment: pw.CrossAxisAlignment.end,
                  children: [
                    pw.Text(TextConstants.payslipForMonth,
            ...
            pw.Text(TextConstants.employeeSummary,
                style:
                ...
                pw.Container(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                          ...
                          children: [
                            pw.Text("₹${data.netPay}",
                                style: pw.TextStyle(
                                    fontSize: 16,
                                    fontWeight: pw.FontWeight.bold)),
                            pw.Text(TextConstants.employeeNetPay,
                      ...
                      _pdfEntry(
                          TextConstants.paidDays, data.paidDays.toString()),
            ...
            pw.Row(
              ...
              children: [
                pw.Text(
                    "${TextConstants.pfAccountNumber}: ${data.pfAccountNumber}",
                    style: pw.TextStyle(fontSize: 10)),
                pw.Text("${TextConstants.uan}: ${data.uan}",
                    style: pw.TextStyle(fontSize: 10)),
              ],
            ),
            pw.SizedBox(height: 12),
            pw.Text(TextConstants.earningsAndDeductions,
            ...
            pw.Table(
              ...
              children: [
                pw.TableRow(
                  decoration:
                      const pw.BoxDecoration(color: AppColors.payslipSectionBg),
                  children: [
            ...
            pw.Container(
              ...
              child: pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
                  pw.Text("${TextConstants.grossEarnings} ₹55,000",
                      style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                  pw.Text("${TextConstants.totalDeductions} ₹10,000",
                      style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                ],
              ),
            ),
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Column(
                    crossAxisAlignment: pw.CrossAxisAlignment.start,
                    children: [
                      pw.Text(TextConstants.totalNetPayable,
                          style: pw.TextStyle(
                              fontSize: 12, fontWeight: pw.FontWeight.bold)),
                      pw.Text(TextConstants.netFormula,
            ...
            pw.SizedBox(height: 12),
            pw.Text(TextConstants.amountInWords,
                style: pw.TextStyle(fontSize: 10)),
            pw.SizedBox(height: 12),
            pw.Center(
                child: pw.Text(TextConstants.autoGenerated,
                    style: pw.TextStyle(fontSize: 8))),
          ],
        ),
      ),
    ...
    final filePath =
        '${directory!.path}/Payslip_${month.replaceAll(" ", "_")}.pdf';
